...
const AIChatSupport = ({
  ...
  const handleSendMessage = async () => {
    if (message.trim()) {
      ...
      try {
        ...
        const aiResponse = await getAIResponse(message, apiKey, modelName);
  ...
  // This is a placeholder function that would be replaced with your actual AI service integration
  const getAIResponse = async (
    ...
    if (userMessage.toLowerCase().includes("pricing")) {
      return "Our pricing plans start at $19/month for the Basic plan, $39/month for the Pro plan, and $59/month for the Enterprise plan. Each plan comes with different features tailored to your business needs.";
    } else if (userMessage.toLowerCase().includes("feature")) {
      return "Our platform offers features like automated invoicing, financial reporting, inventory management, and multi-currency support. Would you like to know more about any specific feature?";
      ...
      return "Thank you for your message. I'm here to help with any questions about our financial software. Feel free to ask about our features, pricing, or how to get started.";
    }
  };
